...
const Blogs = () => {
    return (
        <>
            <div className='blogs-header flex'>
                <div className='flex justify-between'>
                    <div className='md:w-2/4'></div>
                    <div className='container mx-auto text-red-600 md:text-start text-center md:w-2/4 mt-14 md:ml-10'>
                        <h1 className='md:text-5xl text-3xl mb-5'>Welcome to The Blogs World!
                        </h1>
                        <p>Here you can see many blogs of our authors. They wrote this and wants to share with you to enhance you knowledge. Besides this, you can learn about many latest technologies from here. So get ready to go!!</p>
                    </div>
                </div>
            </div>
            <div className='container mx-auto mb-32'>
                <h1 className='text-4xl text-center font-bold mb-3 mt-10'>Latest Blogs</h1>

                {/* blog-01 */}
                <div className='border-2 rounded-lg my-10 md:mx-0 mx-2 px-10 py-6'>
